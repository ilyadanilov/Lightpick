    ...
    var document = window.document,
        ...
        renderCalendar = function (el, opts) {
            ...
            for (var i = 0; i < opts.numberOfMonths; i++) {
                ...
                html +=
                    '<button type="button" class="lightpick__previous-action"><i class="material-icons">arrow_back</i></button>';
                html +=
                    ...
                    "</div>";
                html +=
                    '<button type="button" class="lightpick__next-action"><i class="material-icons">arrow_forward</i></button>';
        ...
        Lightpick = function (options) {
                ...
                if (
                    ...
                    if (
                        ...
                        var start = day.isAfter(opts.startDate)
                                ...
                                ? moment(day)
                                : moment(opts.startDate),
                            isInvalidRange = opts.disableDates.filter(function (
                                d
                            ) {
                                if (
                                    d instanceof Array ||
            ...
            self.showTooltip = function (target, text) {
                ...
                var hasParentEl = self.el.classList.contains(
                        "lightpick--inlined"
                    ),
